        ...
        <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  ...
                  className={`rounded-md px-3 py-2 text-sm font-medium ${
                    pathname === "/"
                      ? "text-white rounded-md bg-lime-300/50"
                      : "text-slate-100"
                  } hover:bg-lime-200/50 hover:cursor-pointer hover:text-white`}
                >
                  Home
                </a>
                <a
          ...
          {isLoggedIn ? (
            ...
            <div className="flex gap-2 max-lg:hidden">
              <Link className="text-slate-50 py-2 px-4" href="/auth/signin">
                Log in
              </Link>
              <Link
                className="text-slate-50 py-2 px-4 bg-lime-300/50 rounded-md"
                href="/auth/signup"
              >
                Sign up
              </Link>
